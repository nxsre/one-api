...
func CreateGlobalWhitelist(c *gin.Context) {
	...
	e := &model.GlobalAccessWhitelist{Type: t, Value: v, Enabled: true, Remark: req.Remark}
...
func CreateGlobalBlacklist(c *gin.Context) {
	...
	e := &model.GlobalAccessBlacklist{Type: t, Value: v, Enabled: true, Remark: req.Remark}
