...
func setDefaults(v *viper.Viper) {
	...
	d("log_async_enabled", true)
	d("log_async_buffer_size", 10000)
	d("log_async_batch_size", 100)
	d("log_async_flush_interval_ms", 1000)
	d("relay_timeout", 0)
	d("relay_max_idle_conns", 200)
	d("relay_max_idle_conns_per_host", 100)
	d("relay_max_conns_per_host", 0)
	d("server_shutdown_timeout", 30)
