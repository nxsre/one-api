...
import { getLegacyConsoleHref } from '@/lib/nacos-console-static';
import { openOneApiUserProfileEdit } from '@/lib/one-api-embed-auth';
            ...
            {!isOidcUser() && (
              <>
                <DropdownMenuItem
                  ...
                  onClick={() => openOneApiUserProfileEdit()}
                >
                  <KeyRound size={14} />
