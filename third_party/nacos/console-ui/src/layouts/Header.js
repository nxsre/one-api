...
import {
  fetchOneApiLogoutSession,
  isEmbeddedUnderOneApi,
  openOneApiUserProfileEdit,
  redirectToOneApiLoginPage,
} from '@/utils/oneApiEmbed';
...
class Header extends React.Component {
  ...
  logout = () => {
    ...
    const embed = isEmbeddedUnderOneApi();
    ...
    void fetchOneApiLogoutSession().finally(finish);
  };
      ...
      <>
        <header className="header-container header-container-primary">
          <div className="header-body">
            ...
            {pathname !== '/login' && (
              <a href="/nacos-ui/" className="ui-switch-btn" title="Switch to new console">
