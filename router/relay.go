...
func registerOpenAIV1RelayRoutes(g *gin.RouterGroup) {
	...
	g.POST("/fine_tuning/jobs", controller.Relay)
	g.GET("/fine_tuning/jobs", controller.Relay)
	g.GET("/fine_tuning/jobs/:id", controller.Relay)
	g.POST("/fine_tuning/jobs/:id/cancel", controller.Relay)
	g.GET("/fine_tuning/jobs/:id/events", controller.Relay)
	g.DELETE("/models/:model", controller.Relay)
	g.POST("/moderations", controller.Relay)
	g.POST("/assistants", controller.Relay)
	g.GET("/assistants/:id", controller.Relay)
	g.POST("/assistants/:id", controller.Relay)
	g.DELETE("/assistants/:id", controller.Relay)
	g.GET("/assistants", controller.Relay)
	g.POST("/assistants/:id/files", controller.Relay)
	g.GET("/assistants/:id/files/:fileId", controller.Relay)
	g.DELETE("/assistants/:id/files/:fileId", controller.Relay)
	g.GET("/assistants/:id/files", controller.Relay)
	g.POST("/threads", controller.Relay)
	g.GET("/threads/:id", controller.Relay)
	g.POST("/threads/:id", controller.Relay)
	g.DELETE("/threads/:id", controller.Relay)
	g.POST("/threads/:id/messages", controller.Relay)
	g.GET("/threads/:id/messages/:messageId", controller.Relay)
	g.POST("/threads/:id/messages/:messageId", controller.Relay)
	g.GET("/threads/:id/messages/:messageId/files/:filesId", controller.Relay)
	g.GET("/threads/:id/messages/:messageId/files", controller.Relay)
	g.POST("/threads/:id/runs", controller.Relay)
	g.GET("/threads/:id/runs/:runsId", controller.Relay)
	g.POST("/threads/:id/runs/:runsId", controller.Relay)
	g.GET("/threads/:id/runs", controller.Relay)
	g.POST("/threads/:id/runs/:runsId/submit_tool_outputs", controller.Relay)
	g.POST("/threads/:id/runs/:runsId/cancel", controller.Relay)
	g.GET("/threads/:id/runs/:runsId/steps/:stepId", controller.Relay)
	g.GET("/threads/:id/runs/:runsId/steps", controller.Relay)
}
